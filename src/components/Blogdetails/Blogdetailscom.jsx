              ...
              <div className="commentform">
                ...
                <form action="">
                  <input
                    ...
                    className="nameinputblog"
                  />
                  <input
                    type="text"
                    placeholder="Your Email"
                    className="emailinputblog"
                  />
                  <textarea
                    name="message"
          ...
          <Col lg={4}>
            <div className="blogdetailright">
              ...
              <div className="blogdetailcategory">
                <h4 className="latesttext">Categories</h4>
                <ul className="catul">
                  <li className="cate"><MdKeyboardDoubleArrowRight className="catarr"/>Web Development</li>
                  <li className="cate"><MdKeyboardDoubleArrowRight className="catarr"/>Social Marketing</li>
                  <li className="cate"><MdKeyboardDoubleArrowRight className="catarr"/>Technology</li>
                  <li className="cate"><MdKeyboardDoubleArrowRight className="catarr"/>Business & Finance</li>
                  <li className="cate"><MdKeyboardDoubleArrowRight className="catarr"/>Digital Solution</li>
                </ul>
              </div>
              <div className="blogdetailcategory">
                <h4 className="latesttext">Tags</h4>
                <ul className="tagul">
                  <li className="head1">Marketing</li>
                  <li className="head1">Development</li>
                  <li className="head1">Design</li>
                  <li className="head1">Digital</li>
                </ul>
              </div>
              <div className="blogdetailcategory">
                <h4 className="latesttext">Comments</h4>
                <ul className="commentul">
                  <li className="commentli"><FaRegCommentDots className="commenticon"/>There are many variations of Lorem available Here</li>
                  <li className="commentli"><FaRegCommentDots className="commenticon"/>There are many variations of Lorem available Here</li>
                  <li className="commentli"><FaRegCommentDots className="commenticon"/>There are many variations of Lorem available Here</li>
                  <li className="commentli"><FaRegCommentDots className="commenticon"/>There are many variations of Lorem available Here</li>
                </ul>
