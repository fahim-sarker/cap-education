        ...
        <Row>
          <Col lg={6}>
            <div className="banner-left">
              ...
              <button className="btn">Take Now<FaArrowRightLong className="icon"/></button>
              <button className="btn1">Find The Course<FaArrowRightLong className="icon"/></button>
              </div>
            </div>
          </Col>
          <Col lg={6}>
            <div className="banner-right">
                ...
                <div className="cart">
                    ...
                    <button className="btnright">Take Now<FaArrowRightLong className="icon"/></button>
                </div>
